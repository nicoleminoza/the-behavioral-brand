...
export const credits: Record<string, CreditSegment[]> = {
  norton: [
    ...
    { text: "Koto’s case study", url: "https://koto.com/projects/the-norton-museum-of-art" },
    { text: ". For the industry reaction, read " },
    { text: "Creative Boom", url: "https://www.creativeboom.com/news/koto-rebrands-the-norton-museum-of-art-with-an-identity-where-art-truly-meets-life/" },
    { text: "." },
  ],
  "sf-symphony": [
    { text: "Read the full " },
    { text: "COLLINS case study", url: "https://wearecollins.com/case-studies/san-francisco-symphony/" },
    { text: " on the visual system and typography. See the font mechanics on the " },
    { text: "Dinamo Typefaces feature page", url: "https://abcdinamo.com/custom/sf-symphony" },
    { text: ". See the typography in action, covered by " },
    { text: "BP&O", url: "https://bpando.org/2022/09/21/branding-san-francisco-symphony/" },
    { text: ". Read more on the sound-driven concept at " },
    { text: "Typeroom", url: "https://www.typeroom.eu/collins-san-francisco-symphony-variable-type" },
    { text: "." },
  ],
  guggenheim: [
    { text: "See the full system in " },
    { text: "Pentagram’s case study", url: "https://www.pentagram.com/work/guggenheim-3/story" },
    { text: ". For the industry reaction, read " },
    { text: "Creative Review", url: "https://www.creativereview.co.uk/pentagram-guggenheim-rebrand/" },
    { text: ", " },
    { text: "Brand New", url: "https://www.underconsideration.com/brandnew/archives/new_logo_and_identity_for_guggenheim_by_pentagram.php" },
    { text: ", and " },
    { text: "Creative Boom", url: "https://www.creativeboom.com/news/pentagram-unveils-a-unified-global-identity-for-the-guggenheim/" },
    { text: "." },
  ],
  brooklyn: [
    { text: "See the rebrand in the " },
    { text: "Brooklyn Museum’s announcement", url: "https://www.brooklynmuseum.org/stories/new-brand" },
    { text: ". For the industry reaction, read " },
    { text: "Print Magazine", url: "https://www.printmag.com/branding-identity-design/the-brooklyn-museum-unveils-a-bold-rebrand-for-its-200th-anniversary/" },
    { text: " and " },
    { text: "Creative Boom", url: "https://www.creativeboom.com/news/the-brooklyn-museum-unveils-its-new-look-with-its-200-year-history-at-its-heart/" },
    { text: "." },
  ],
  nhm: [
    { text: "See the full system in the case studies from " },
    { text: "Pentagram", url: "https://www.pentagram.com/work/natural-history-museum" },
    { text: " and " },
    { text: "Nomad Studio", url: "https://www.nomadstudio.com/work/natural-history-museum" },
    { text: ". For the industry reaction, read " },
    { text: "It’s Nice That", url: "https://www.itsnicethat.com/news/pentagram-nomad-natural-history-museum-graphic-design-190723" },
    { text: ", " },
    { text: "Creative Review", url: "https://www.creativereview.co.uk/natural-history-museum-branding/" },
    { text: ", and " },
    { text: "BP&O", url: "https://bpando.org/2023/08/24/museum-branding-motion-graphics-pentagram-nomad-natural-history-museum-london/" },
    { text: "." },
  ],
  "young-vic": [
    { text: "See venturethree’s system covered on " },
    { text: "It’s Nice That", url: "https://www.itsnicethat.com/articles/venturethree-young-vic-graphic-design-project-280526" },
    { text: "." },
  ],
  leeum: [
    { text: "See the full system in " },
    { text: "Wolff Olins’ case study", url: "https://www.wolffolins.com/work/leeum" },
    { text: ". For the industry reaction, read " },
    { text: "It’s Nice That", url: "https://www.itsnicethat.com/news/wolff-olins-leeum-museum-of-art-graphic-design-060922" },
    { text: ", " },
    { text: "Creative Review", url: "https://www.creativereview.co.uk/leeum-museum-branding/" },
    { text: ", and " },
    { text: "Brand New", url: "https://www.underconsideration.com/brandnew/archives/new_logo_and_identity_for_leeum_museum_of_art_by_wolff_olins.php" },
    { text: "." },
  ],
  "national-ballet": [
    { text: "See the full system on " },
    { text: "Bruce Mau Design", url: "https://www.brucemaudesign.com/news/creative-boom-features-nboc-rebrand" },
    { text: ". For the industry reaction, read " },
    { text: "Print Magazine", url: "https://www.printmag.com/branding-identity-design/bruce-mau-design-the-national-ballet-of-canada-new-identity/" },
    { text: ", " },
    { text: "Creative Boom", url: "https://www.creativeboom.com/news/rebrand-of-the-national-ballet-of-canada/" },
    { text: ", and " },
    { text: "Transform Magazine", url: "https://www.transformmagazine.net/articles/2024/the-national-ballet-of-canada-unveils-inviting-rebrand/" },
    { text: "." },
  ],
};
