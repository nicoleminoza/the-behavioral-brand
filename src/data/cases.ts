...
export const credits: Record<string, CreditSegment[]> = {
  ...
  "sf-symphony": [
    ...
    { text: ". For a breakdown of the variable type, read " },
    { text: "Typeroom", url: "https://www.typeroom.eu/collins-san-francisco-symphony-variable-type" },
    { text: ". For the details about the sound-driven design, read " },
    { text: "Print Magazine", url: "https://www.printmag.com/branding-identity-design/collins-new-identity-for-the-san-francisco-symphony-brings-the-noise/" },
    { text: "." },
  ],
  guggenheim: [
    { text: "See the full system in " },
